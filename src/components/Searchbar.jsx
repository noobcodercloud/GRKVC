            ...
            >
              {
                FilteredData.map(e => {
                  return (
                    <div key={e} className='p-3 w-full ml-1.25 border-b border-gray-500/30 hover:bg-gray-200/10 hover:backdrop-filter hover:backdrop-blur transition-all' onClick={handleClick}>
                      <div>
                        {e}
                      </div>
                    </div>
